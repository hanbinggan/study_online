    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row placeholders">
                ...
                <form:form class="form-horizontal" method="post" modelAttribute="teacher" action="/manage/teacher/update">
                    <form:input path="id" type="hidden" class="form-control" id="id" value="${teacher.id}"/>

                    <div class="form-group">
                        <label for="email" class="col-sm-2 control-label">邮箱</label>
                        <div class="col-sm-5">
                            <form:input path="email" type="text" class="form-control" id="email" value="${teacher.email}" readonly="true"/>
                        </div>
                    </div>
                    <div class="form-group">
